...
public:
    ...
    pool_allocator() : _freeHead{nullptr} {
    ...
    pool_allocator(const pool_allocator&) : _freeHead{nullptr} {}
    ...
    void deallocate(pointer __p, size_type) {
        ...
        // link free
        deallocElement->ptrNext = _freeHead;
        _freeHead = deallocElement;
    }

    size_type max_size() const { return size_t(-1) / sizeof(T); }

    void construct(pointer __p, const T& __val) { ::new ((void*)__p) T(__val); }
