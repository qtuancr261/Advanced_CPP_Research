...
#include "../WheatherStation/subject/weatherdata.h"
...
QT_MOC_LITERAL(1, 12, 19), // "measurementsChanged"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "WeatherData\0measurementsChanged\0"
};
...
void WeatherData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->measurementsChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WeatherData::measurementsChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WeatherData::staticMetaObject = {
    { &Subject::staticMetaObject, qt_meta_stringdata_WeatherData.data,
      qt_meta_data_WeatherData,  qt_static_metacall, nullptr, nullptr}
};
...
void *WeatherData::qt_metacast(const char *_clname)
{
    ...
    return Subject::qt_metacast(_clname);
}

int WeatherData::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Subject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
